                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route(Route::currentRouteName(), 'ru') }}">{{__('RU')}}</a>
                            </li>
                            <li class="nav-item">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <form id="logout-form" action="{{ route('logout', ['language' => app()->getLocale()]) }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
                                </div>
                            </li>
